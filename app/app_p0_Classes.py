...
#request é usado para converter os dados enviados pelo cliente (como JSON) em um formato que o Python pode entender, e jsonify é usado para converter as respostas do Python em JSON, que é um formato de dados leve e amplamente utilizado para comunicação entre clientes e servidores.
